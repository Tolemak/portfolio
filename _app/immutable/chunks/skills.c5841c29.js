import{A as a}from"./UIcon.83f396f4.js";function g(e,...t){const s=Object.assign({},e);return Object.keys(s).forEach(r=>{t.includes(r)&&delete s[r]}),s}const i=e=>e,p=[i({name:"Programming Languages",slug:"pro-lang"}),i({name:"Frameworks",slug:"framework"}),i({name:"Libraries",slug:"library"}),i({name:"Langauges",slug:"lang"}),i({name:"Databases",slug:"db"}),i({name:"ORMs",slug:"orm"}),i({name:"DevOps",slug:"devops"}),i({name:"Testing",slug:"test"}),i({name:"Dev Tools",slug:"devtools"}),i({name:"Markup & Style",slug:"markup-style"}),i({name:"Design",slug:"design"}),i({name:"Soft Skills",slug:"soft"})],n=e=>{const t=g(e,"category");return e.category&&(t.category=p.find(s=>s.slug===e.category)),t},c=[n({slug:"js",color:"yellow",description:`<p>
			...
			</p>`,logo:a.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"php",color:"blue",description:`<p>1. PHP REST API Architect:<br>
			...
			</p>`,logo:a.PHP,name:"PHP",category:"pro-lang"}),n({slug:"python",color:"blue",description:`<p>1. Python Data Wizard:<br>
			...
			4. Efficient Script Developer:<br>
			   ...
			   </p>`,logo:a.Python,name:"Python",category:"pro-lang"}),n({slug:"sql",color:"blue",description:`<p>1. SQL Virtuoso Across Platforms:
